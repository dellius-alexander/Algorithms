...
public class Dijkstra extends DijkstraInterface<Object,Object,Object>
{
    ...
    public static List<Node<Object,Object,Object>> calculateMinimumPath(
        ...
        Edge<Distance<Object>,Node<Object,Object,Object>> parentNodeEdge = dijkstra.getMinimumCostNodeEdge(frontier);

        // for each neighbor adjacent node of the minimum distance node, where n has not yet been
        // removed from unsettled nodes do;
        for (Edge<Distance<Object>, Node<Object,Object,Object>> childNodeEdge : parentNodeEdge.getNode().getEdges())
        {

            // temp container for nodes discovered on the frontier aka settled nodes
            List<Node<Object,Object,Object>> tempShortestPath = new LinkedList<>();
            ...
            if (dijkstra.evaluateGoal(parentNodeEdge,childNodeEdge))
            {
                ...
                if (!shortestPath.contains(destinationNode))
                {
                    ...
                    tempShortestPath.addAll(calculateMinimumPath(
                            graph,
